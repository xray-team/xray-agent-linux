...
### logLevel
Допустимые значения:
* default - стандартный уровень логирования
* debug - стандартный уровень логирования + диагностическая информация
### logOut
Допустимые значения:
* syslog - лог отправляется в syslog
* stdout - лог отправляется в stdout
